...
class StockViewer {
    constructor() {
        console.log('StockViewer constructor called - LATEST TIMESTAMPED FILE LOADED!');
        console.log('Testing latest timestamped file loading...');
        console.log('Timestamp:', new Date().toISOString());
        console.log('File: stock_viewer_1754270343.js');
    ...
    initializeEventListeners() {
        ...
        if (dropdownButton) {
            console.log('Found dropdown button, adding event listener');
