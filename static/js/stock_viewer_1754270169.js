...
class StockViewer {
    constructor() {
        console.log('StockViewer constructor called - TIMESTAMPED FILE LOADED!');
        console.log('Testing timestamped file loading...');
        console.log('Timestamp:', new Date().toISOString());
        console.log('File: stock_viewer_1754270169.js');
