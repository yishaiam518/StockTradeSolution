#!/usr/bin/env python3
"""
Test historical backtest with a more volatile period.
"""
...
def test_volatile_period():
    """Test with a more volatile period (March 2020 - COVID crash)."""
    
    print("=== TESTING VOLATILE PERIOD (March 2020) ===")
    
    # Get config
    config_dict = config.config
    
    # Test with March 2020 (COVID crash - very volatile)
